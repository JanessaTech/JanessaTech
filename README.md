...
**JanessaTech**(Juan Zhao in Chinese name) is **a Senior Full-Stack Engineer** with 10+ years of experience at IBM & Huawei etc and a Master degree in CS from Xi'an Jiaotong Universit. Specializing in **Web3 & DeFi** for the past three years, she has deep expertise in **building decentralized applications from 0→1** — from smart contract integration to frontend optimization.
