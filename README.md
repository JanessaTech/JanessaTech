...
**JanessaTech**(Juan Zhao in Chinese name) isn't just **a fullstack blockchain engineer** with **Master Degree** in CS, **focusing on SaaS consulting in blockchain space powered by the end-to-end development process**. 
